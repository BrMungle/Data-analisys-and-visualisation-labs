...
colors = ['gray','red','gold','royalblue','plum','k','mediumvioletred','darkseagreen']
...
if(len(sys.argv) > 1):
    if sys.argv[1] == '1':
        fig.savefig('plots/task5c.png')
        print('Plot saved in: '+str(pathlib.Path().absolute()) + '/plots/task5c.png')
    elif sys.argv[1] == '0':
        plt.show()  
