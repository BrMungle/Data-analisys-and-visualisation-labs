...
for country in list(set(temperatures['Country'])):
    ...
    ax.plot(table_temp['year'], table_temp['avg_temperature_in_year'],'k-')
...
if(len(sys.argv) > 1):
    if sys.argv[1] == '1':
        fig.savefig('plots/task4b.png')
        print('Plot saved in: '+str(pathlib.Path().absolute()) + '/plots/task4b.png')
    elif sys.argv[1] == '0':
        plt.show()
